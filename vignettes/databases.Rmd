...
`lexicoR` contains two lexical databases, [DeepLex](http://dx.doi.org/10.6129%2fCJP.201909_61(3).0004) and [Chinese Lexical Database](http://www.chineselexicaldatabase.com). The function, `query.lu()`, can be used to query lexical entries in these databases. See the bottom of the page for Chinese Lexical Database's original paper. All rights of the Chinese Lexical Database belong to the original authors.
